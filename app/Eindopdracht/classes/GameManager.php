<?php
      ...
      public function insertGame($data, $imageName) {
          ...
          //check if name and email are correct
            ...
            try {
              ...
              $stmt = $this->conn->prepare("INSERT INTO games (title, genre, platform, release_year, rating, descriptionGame, image) VALUES (:title, :genre, :platform, :release_year, :rating, :descriprion, :image)");
      ...
      try {
        ...
        foreach($games as $data) {
          ...
          echo "<tr>";
            ...
            echo '<td><a href="http://localhost/eindopdracht/detail_page.php?' . "id=" . $id . '"' . "><img  class = 'picture' src='uploads/" . $data->get_image() . "'></a></td>"; 
          echo "</tr>";
    ...
    public function selectDataSideBar() {
      ...
      try {
        ...
        foreach($games as $data) {
          $id = $data->get_id();
            echo '<li><a href="http://localhost/eindopdracht/detail_page.php?' . "id=" . $id . '"' . ">" . "<img  class = 'smallPicture' src='uploads/" . $data->get_image() . "'>"; 
    ...
    function get_game_details($id) {
      try {
          $stmt = $this->conn->prepare("SELECT title, genre, platform, release_year, rating, descriptionGame, image FROM games WHERE id = :id");
